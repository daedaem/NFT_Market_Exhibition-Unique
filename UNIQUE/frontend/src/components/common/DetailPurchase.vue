<template>
  <div>
    <button type="button" data-bs-toggle="modal" :data-bs-target="`#modal` + `${product}`" class="btn btn-sm btn-dark d-block">Purchase</button>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <button class="btn btn-dark d-block" @click="purchaseNFT" :data-bs-target="`#modal` + `${product}`" data-bs-toggle="modal">Confirm</button>
          </div>
          <!-- end modal-body -->
        </div>
        <!-- end modal-content -->
    ...
    <!-- end firstmodal -->
    <!-- start second modal -->
    <div class="modal fade" :id="`modal${product}`" tabindex="-1" aria-hidden="true" v-if="authorPrivateKey">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
