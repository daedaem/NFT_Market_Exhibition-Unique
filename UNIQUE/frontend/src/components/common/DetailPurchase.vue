      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <button class="btn btn-dark d-block" @click="detailPurchaseNFT" :data-bs-target="`#modal` + `${product.marketId}`" data-bs-toggle="modal">Confirm</button>
