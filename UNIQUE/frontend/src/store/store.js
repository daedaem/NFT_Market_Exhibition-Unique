...
let SectionData = {
  ...
  blogDetail: {
    img: require("@/images/thumb/blog-img.jpg"),
    content:
      "Predictions for how secondary NFT sales will revolutionize creative industries. Elementum lacus, tempus aliquam turpis diam amet leo enim. Nisi enim condimentum tincidunt ornare nam adipiscing. Volutpat lacus, est hendrerit elit sed interdum. amet leo enim.",
    contentTwo:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elementum lacus, tempus aliquam turpis diam amet leo enim. Nisi enim condimentum tincidunt ornare nam adipiscing. Volutpat lacus, est hendrerit elit sed interdum. amet leo enim.",
    quoteText:
      "Design can be art. Design can be simple. That’s why it’s so complicated. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.",
    contentThree:
      "A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth. There live the blind texts.",
    contentFour:
      "Astro ipsum dolor sit amet, consectetur adipiscing elit. Elementum lacus, tempus aliquam turpis diam amet leo enim. Nisi enim condimentum tincidunt ornare nam adipiscing. Volutpat lacus, est hendrerit elit sed interdum. amet leo enim.",
  ...
  securityData: {
    ...
    content:
      'EnftyMart uses <a href="#" class="btn-link text-primary">Authy</a> as a 2fa provider. On enrollment in 2fa, we will send you a link to download authy and a code to confirm your phone number. You will then recieve 2fa requests through this app.',
    logos: [
      {
        id: 1,
        path: "",
    ...
    contentTwo:
      "In cases where authy cannot be installed, sms messaging can be used for 2fa. <strong>This is a last case scenario </strong> as sms provides a <strong>less secure</strong> experience and will prevent you from enabling advanced 2fa settings within the site.",
  ...
  transactionsData: {
    ...
    transactionsTableHead: ["#", "Customer", "Issue Date", "Total", "Type", "Status", "Action"],
  ...
  depositData: {
    ...
    content:
      'Only EnftyMart collection Enfties can be deposited. To check if your Enfty is eligible for deposit, click <a href="#" data-bs-toggle="modal" data-bs-target="#depositNiftyModal" class="btn-link">Here</a>',
