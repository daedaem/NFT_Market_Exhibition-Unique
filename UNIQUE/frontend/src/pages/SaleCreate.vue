            ...
            <form action="#" class="form-create mb-5 mb-lg-0">
              ...
              <div class="form-item mb-4">
                <div class="mb-4">
                  ...
                  <p class="my-1 text-black"><strong class="text-red">Warning</strong> : keep your private key safely</p>
                  <div class="d-flex">
                    <input class="form-control form-control-s1 col-7" type="text" v-model="password" />
                    <!-- end form-item -->
