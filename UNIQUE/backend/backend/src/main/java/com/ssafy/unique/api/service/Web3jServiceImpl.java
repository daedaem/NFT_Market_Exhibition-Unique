...
public class Web3jServiceImpl implements Web3jService{
    ...
    public BigInteger test() throws Exception {
        ...
        Credentials credential = Credentials.create("0x03dc588c73e2a37031c7b58e8af342ec67fbd70d34833a9cde10780c5c9cdd30");
        ...
        ERC20 erc20 = ERC20.load("0x6C927304104cdaa5a8b3691E0ADE8a3ded41a333",web3j,manager,new DefaultGasProvider());
        BigInteger balance = erc20.balanceOf("0x585B365a684C69Dd4d475e444CbD73c6F9a1997e").send();
        return balance;
    }
