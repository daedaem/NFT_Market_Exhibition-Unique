...
public interface ExhibitionRepository extends JpaRepository<Exhibition, Long>{
	...
	@Query( value = " select * from exhibition limit ? offset ? ", nativeQuery = true)
	...
	@Query( value = " select * from exhibition where exhibition_type = ? limit ? offset ? ", nativeQuery = true)
